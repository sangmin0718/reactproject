...
export default function Autumn({ onNext }) {
  const [selected, setSelected] = useState(null);

  const choices = [
    { id: 'scarf', image: require('../assets/images/scarf.png'), correct: false },
    { id: 'ssuk', image: require('../assets/images/ssuk.png'), correct: false },
    { id: 'sandals', image: require('../assets/images/sandals.png'), correct: false },
    { id: 'chestnut', image: require('../assets/images/chestnut.png'), correct: true },
  ];
  ...
  return (
    <View style={styles.container}>
      <Image 
        source={require('../assets/images/autumn.png')}
        style={styles.seasonImage}
      />

      <Text style={styles.questionText}>가을과 어울리는 이미지를 골라보세요</Text>
