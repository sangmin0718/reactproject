...
export default function Winter({ onNext }) {
  const [selected, setSelected] = useState(null);

  const choices = [
    { id: 'scarf', image: require('../assets/images/scarf.png'), correct: true },
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.questionText}>겨울과 어울리는 이미지를 골라보세요</Text>
