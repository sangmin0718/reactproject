...
export default function Summer({ onNext }) {
  ...
  const choices = [
    ...
    { id: 'sandals', image: require('../assets/images/sandals.png'), correct: true},
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.questionText}>여름과 어울리는 이미지를 골라보세요</Text>
